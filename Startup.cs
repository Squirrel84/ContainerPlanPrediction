...
namespace ContainerPlanPrediction
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            DragDropContainerService dragDropContainerService = new DragDropContainerService();

            services.AddRazorPages();
            services.AddServerSideBlazor();
            services.AddSingleton<WeatherForecastService>();
            services.AddSingleton<ShippingRouteService>(shippingRouteService);
            services.AddSingleton<DragAndDropService<ContainerDestination>>(dragDropContainerService);
            services.AddSingleton<DragDropContainerService>(dragDropContainerService);
